...
<head>
    ...
    <link rel="stylesheet" href="/shopvotcaulong/Public/assets/css/web.css">
...
<header>
    <div class="header-top d-flex flex-wrap justify-content-between align-items-center">
        ...
        <div class="header-info d-flex flex-wrap justify-content-center gap-3">
            ...
            <span><i class="ti-user"></i> TÀI KHOẢN</span>
        ...
        <div class="btn-login-group d-flex gap-2">
            <a href="/shopvotcaulong/Public/index.php?controller=user&action=register" class="btn-dangky">Đăng ký</a>
            <a href="/shopvotcaulong/Public/index.php?controller=user&action=login" class="btn-dangnhap">Đăng nhập</a>
        </div>
    </div>
    <div class="menu-chinh">
        <ul class="d-flex flex-wrap justify-content-center gap-3">
            <li><a href="/shopvotcaulong/Public/index.php?controller=home&action=index">TRANG CHỦ</a></li>
            <li><a href="/shopvotcaulong/Public/index.php?controller=product&action=index">SẢN PHẨM</a></li>
